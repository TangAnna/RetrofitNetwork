package com.example.tang.androidframe.cache;
...
import com.example.tang.androidframe.constan.SpConstant;
...
public class SpUtils {
    ...
    public static void putToken(String token) {
        getSp(FrameApplication.getContext());
        sp.edit().putString(SpConstant.ACCESS_TOKEN, token).commit();
    }
